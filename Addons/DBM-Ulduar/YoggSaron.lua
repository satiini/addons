...
function mod:SPELL_CAST_START(args)
	if args.spellId == 64059 then	-- Induce Madness
		...
		sndWOP:Schedule(78, "Interface\\AddOns\\DBM-Core\\extrasounds\\indoorsoon.mp3")
		specWarnMadnessOutNow:Schedule(55)
		sndWOP:Schedule(55, "Interface\\AddOns\\DBM-Core\\extrasounds\\outdoornow.mp3")
	elseif args.spellId == 64189 then		--Deafening Roar
		timerNextDeafeningRoar:Start()
		warnDeafeningRoarSoon:Schedule(55)
		sndWOP:Schedule(55, "Interface\\AddOns\\DBM-Core\\extrasounds\\silencesoon.mp3")
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(64126, 64125) then	-- Squeeze
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\killmhand.mp3")
	...
	elseif args.spellId == 63138 then	-- Sara's Fervor
		...
		if args:IsPlayer() then 
			specWarnFervor:Show()
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\fever.mp3")
		end
	elseif args.spellId == 63894 then	-- Shadowy Barrier of Yogg-Saron (this is happens when p2 starts)
		...
		sndWOP:Schedule(57, "Interface\\AddOns\\DBM-Core\\extrasounds\\indoorsoon.mp3")
		warnP2:Show()
		if self.Options.ShowSaraHealth then
	...
	elseif args.spellId == 64465 then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\marknow.mp3")
...
function mod:OnSync(msg)
	if msg == "Phase3" then
		...
		warnEmpowerSoon:Schedule(40)
		sndWOP:Schedule(40, "Interface\\AddOns\\DBM-Core\\extrasounds\\marksoon.mp3")
		sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\indoorsoon.mp3")
		timerNextDeafeningRoar:Start(30)
		warnDeafeningRoarSoon:Schedule(25)
		sndWOP:Schedule(25, "Interface\\AddOns\\DBM-Core\\extrasounds\\silencesoon.mp3")
	end
end
