...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(68981) then -- Remorseless Winter (phase transition start)
		sndWOP:Schedule(54, "Interface\\AddOns\\DBM-Core\\extrasounds\\ptwo.mp3")
		warnRemorselessWinter:Show()
		timerPhaseTransition:Start()
		timerRagingSpiritCD:Start(6)
		sndWOP:Schedule(4, "Interface\\AddOns\\DBM-Core\\extrasounds\\ghostsoon.mp3")
		warnShamblingSoon:Cancel()
		timerShamblingHorror:Cancel()
		timerDrudgeGhouls:Cancel()
		timerInfestCD:Cancel()
		sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\infestsoon.mp3")
	...
	elseif args:IsSpellID(72259) then -- Remorseless Winter (phase transition start) second cast of fight
		sndWOP:Schedule(54, "Interface\\AddOns\\DBM-Core\\extrasounds\\pthree.mp3")
		warnRemorselessWinter:Show()
		timerPhaseTransition:Start()
		timerRagingSpiritCD:Start(6)
		sndWOP:Schedule(4, "Interface\\AddOns\\DBM-Core\\extrasounds\\ghostsoon.mp3")
		timerSummonValkyr:Cancel()
		sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\valkysoon.mp3")
		timerInfestCD:Cancel()
		sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\infestsoon.mp3")
		timerDefileCD:Cancel()
		sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\defilesoon.mp3")
	...
	elseif args.spellId == 70541 then -- Infest
		...
		specWarnInfest:Show()
		timerInfestCD:Start()
		sndWOP:Schedule(16.5, "Interface\\AddOns\\DBM-Core\\extrasounds\\infestsoon.mp3")
	...
	elseif args.spellId == 72762 then -- Defile
		...
		timerDefileCD:Start()
		sndWOP:Schedule(27, "Interface\\AddOns\\DBM-Core\\extrasounds\\defilesoon.mp3")
	...
	elseif args.spellId == 73650 then -- Restore Soul (Heroic)
		...
		sndWOP:Schedule(37, "Interface\\AddOns\\DBM-Core\\extrasounds\\defilesoon.mp3")
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif args.spellId == 69200 then -- Raging Spirit
		...
		if phase == 1 then
			...
			sndWOP:Schedule(20, "Interface\\AddOns\\DBM-Core\\extrasounds\\ghostsoon.mp3")
		else
			timerRagingSpiritCD:Start(17)
			sndWOP:Schedule(15, "Interface\\AddOns\\DBM-Core\\extrasounds\\ghostsoon.mp3")
		end
	...
	elseif args.spellId == 68980 then -- Harvest Soul
		...
		if mod:IsHealer() and (mod:IsDifficulty("normal10") or mod:IsDifficulty("normal25")) then
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\harvestsoul.mp3")
		end
		if args:IsPlayer() then
...
function mod:SPELL_AURA_APPLIED(args)
	if args.spellId == 72143 then -- Shambling Horror enrage effect.
		...
		timerEnrageCD:Start()
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\enrage.mp3")
	...
	function mod:SPELL_SUMMON(args)
		if args.spellId == 69037 then -- Summon Val'kyr
			if time() - lastValk > 15 then -- show the warning and timer just once for all three summon events
				...
				sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\killvalkyr.mp3")
				sndWOP:Schedule(41, "Interface\\AddOns\\DBM-Core\\extrasounds\\valkysoon.mp3")
...
function mod:NextPhase()
	...
	elseif phase == 2 then
		...
		sndWOP:Schedule(16, "Interface\\AddOns\\DBM-Core\\extrasounds\\valkysoon.mp3")
		timerSoulreaperCD:Start(40)
		timerDefileCD:Start(38)
		timerInfestCD:Start(14)
		sndWOP:Schedule(8, "Interface\\AddOns\\DBM-Core\\extrasounds\\infestsoon.mp3")
		countdownInfest:Start(14)
		warnDefileSoon:Schedule(33)
		sndWOP:Schedule(33, "Interface\\AddOns\\DBM-Core\\extrasounds\\defilesoon.mp3")
	elseif phase == 3 then
		...
		warnDefileSoon:Schedule(33)
		sndWOP:Schedule(34, "Interface\\AddOns\\DBM-Core\\extrasounds\\defilesoon.mp3")
	end
end
